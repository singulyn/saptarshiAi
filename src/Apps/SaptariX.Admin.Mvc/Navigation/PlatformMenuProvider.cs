...
public sealed class PlatformMenuProvider : IMenuProvider
{
    public void RegisterMenus(IMenuRegistry registry)
    {
        ...
        registry.Add(new MenuItemDefinition("Users", "/Users", PlatformPermissions.UsersView, "fa-solid fa-users", 40));
        registry.Add(new MenuItemDefinition("Roles", "/Roles", PlatformPermissions.RolesView, "fa-solid fa-user-shield", 45));
        registry.Add(new MenuItemDefinition("Permissions", "/Permissions", PlatformPermissions.PermissionsView, "fa-solid fa-key", 50));
